...
const BBMP_HP = () => {
    ...
    const reports_cardData = [
        // Reports
        { iconClass: "fas fa-chart-bar", title: "Dashboard", link: "https://bbmpeaasthi.karnataka.gov.in/office/PublicReports/frmDashBoardNew.aspx" },
    ...
    function LayoutKhataCard({ iconClass, title, link }) {
        return (
            <div className="col-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 mb-4 d-flex align-items-stretch">
                <a
                    href={link}
    ...
    return (
        <HomePageLayout>
            ...
            <div className="container mt-4">
                ...
                {/* Data Entry */}
                <div className="row justify-content-center">
                    <h3 className="animated-underline">Entry Form</h3>
                ...
                {/* things to know */}
                <div className="row justify-content-center">
                    <h3 className="animated-underline">Things to Know</h3>
                ...
                {/* <h1 className="section-heading">Layout Khata Section</h1> */}
                <div className="row justify-content-center">
                    <h3 className="animated-underline">Layout Khata Section</h3>
                    {layoutkhata_cardData.map((card, index) => (
                        <LayoutKhataCard key={index} iconClass={card.iconClass} title={card.title} link={card.link} />
                    ))}
                </div>
