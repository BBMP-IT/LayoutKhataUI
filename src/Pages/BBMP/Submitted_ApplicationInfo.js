...
const BBMP_SubmittedInfo = () => {
    ...
    const printData = () => {
        ...
        // Optional: delay hiding to ensure print dialog completes
        setTimeout(() => {
                        ...
                        <div className="card-body">
                            ...
                            <div className='row'>
                                ...
                                {shouldShowReleaseButton && (
                                    <div className='col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2 mt-3 no-print'>
                                ...
                                {(ecNumber || typeof isJDA === 'boolean') && (
                                    <>
                                        <div style={{ marginTop: '20px' }}>
                                            ...
                                            {/* <p className='mb-4'>Note : EC should be atleast 1 day before registered deed of property until 31-10-2024 or later. If sale / registered deed date is before 01-04-2004 then EC should be from 01-04-2004 to 31-10-2024 or after</p> */}
                                            <div className='row'>
                                                <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-3">
                                                    ...
                                                    {/* <div className="text-success no-print">
                                                        <strong>EC Check successfully <i className="fa fa-check-circle"></i></strong>
                                                    </div> */}
                                                </div>
                                                <div className="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2 mt-7 no-print">
                                                    <div className="form-group">
                                                ...
                                                {hasJDA === true && isRegistered === true && (
                                                    <>
                                                        ...
                                                        <div className="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2 mt-5 no-print">
                                                            <div className="form-group">
                                                                <button className="btn btn-warning btn-block" onClick={handleViewDeed}>
                                                                    View Deed
                                                                </button>
...
const Preview_siteDetailsTable = ({ data, setData, totalSitesCount, }) => {
    ...
    return (
        <div>
            ...
            <div style={{ overflowX: "auto", padding: "1rem" }} className='print-table-container'>
                <table
                    {...getTableProps()}
                    style={{
