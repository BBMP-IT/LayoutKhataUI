...
const BBMP_Home = () => {
    ...
    const cardData = [
        ...
        { iconClass: "fas fa-map-marked-alt", title: "Draft eKhatha (if you don't know Ward)", link: "https://bbmpeaasthi.karnataka.gov.in/citizen_core/GoogleMapsWardCoordinates" },
